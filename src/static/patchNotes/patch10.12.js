module.exports = {
  number: '10.12',
  sourceUrl: 'https://na.leagueoflegends.com/en-us/news/game-updates/teamfight-tactics-patch-10-12-notes/',
  timestamp: new Date(),
  title: '',
  categories: [{
    title: 'Mid-Patch Update',
    sections: [{
      title: 'Protector',
      notes: [
