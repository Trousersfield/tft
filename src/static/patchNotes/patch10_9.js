module.exports = {
  number: '10.9',
  sourceUrl: 'https://na.leagueoflegends.com/en-us/news/game-updates/teamfight-tactics-patch-10-9-notes/',
  timestamp: new Date(),
  title: '',
  categories: [{
    title: 'Systems',
    sections: [{
      title: 'Champion Shop Drop Rates',
      notes: [
    ...
    sections: [{
      ...
      title: 'General balance and other adjustments',
      notes: [
